            ...
            <div class="max-w-screen-xl mx-auto py-10 ">
                ...
                <table class="w-full border-collapse">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr class="border-b">
                            <td class="px-4 py-2 w-24">{{ $detail->room->room_name ?? '-' }}</td>
                            <td class="px-4 py-2 w-24">{{ $detail->booking_detail_status }}</td>
                            ...
                            <td class="px-4 py-2 w-32">
                                ...
                                <form action="{{ route('booking.requestSoap', $detail->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-700">
                                        <i class="fa-solid fa-soap"></i> ขอสบู่เพิ่ม
                                    </button>
                                </form>
                                @else
                                <span class="text-gray-500">คุณขอสบู่ไปแล้ว</span>
                                @endif
                            </td>
                            <td class="px-4 py-2 w-32">
                                ...
                                <form id="checkoutForm-{{ $booking->id }}"
                                    action="{{ route('checkoutuser') }}" method="post" class="hidden">
                                    @csrf
                                    <input type="hidden" name="booking_id" value="{{ $booking->id }}">
                                </form>
                                @else
                                <span class="text-gray-500">ไม่สามารถเช็คเอาท์ได้</span>
                                @endif
                            </td>
                        </tr>
                        @endif
