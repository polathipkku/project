            ...
            <div class="col-span-5">
                <div id="default-carousel" class="relative w-full" data-carousel="slide">
                    <div class="relative h-60 overflow-hidden">
                        ...
                        {{-- ตรวจสอบว่า room_image เป็น array หรือไม่ --}}
                        @php
                        $images = is_array($room->room_image) ? $room->room_image : json_decode($room->room_image, true);
                        @endphp
                        @foreach ($images as $image)
                        <div class="hidden duration-700 ease-in-out" data-carousel-item>
                            <img src="{{ asset('images/' . $image) }}" class="absolute block w-full h-full object-cover" alt="Room Image">
                        </div>
                        @endforeach
                        @else
