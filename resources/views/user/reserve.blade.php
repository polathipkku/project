                        ...
                        <div class="flex justify-between items-center p-4">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <div class="flex flex-col">
                                    <span class="text-blue-500 font-semibold text-lg">ดูเหมือนว่าคุณยังไม่ได้เป็นสมาชิก</span>
                            ...
                            <div class="flex flex-col items-end">
                                <button onclick="showLoginForm()" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 w-40 rounded focus:outline-none focus:shadow-outline">
                                    Login
                                </button>
                        ...
                        <div class="mb-2 mt-1 grid grid-cols-6 gap-x-2 ">
                            <div class="flex flex-col items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V9a4 4 0 10-8 0v4M4 9v4m0 4h16m-8 2a2 2 0 110-4 2 2 0 010 4z" />
                                </svg>
                                <span class="text-sm">ส่วนลดพิเศษ</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c1.5 0 3 .672 3 2v2h-6V9c0-1.328 1.5-2 3-2zm0-3a5 5 0 100 10 5 5 0 000-10zm0 15c1.657 0 3-1.343 3-3h-6c0 1.657 1.343 3 3 3zm4.218-8.215c1.468-.365 2.78-.859 2.78-1.785 0-.927-1.312-1.42-2.78-1.785m-8.436 0c-1.468.365-2.78.859-2.78 1.785 0 .927 1.312 1.42 2.78 1.785" />
                                </svg>
                                <span class="text-sm">ข้อเสนอพิเศษ</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v2a2 2 0 002 2h2a2 2 0 002-2v-2m0-3v-2a3 3 0 10-6 0v2m6-10h2a2 2 0 012 2v2m-2-4a2 2 0 012 2m-2 2h-2m-4 4v-4h-4m0 0a2 2 0 012-2m2 2v4" />
                                </svg>
                                <span class="text-sm">ของขวัญฟรี</span>
                            </div>
                            <div class="flex flex-col items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7m2-5a10 10 0 11-10 10 10 10 0 0110-10z" />
                                </svg>
