...
<body>
    ...
    <div class="hero-content flex justify-center items-center flex-col mt-7" style="background-image: url(images/TT1.png); height: 500px; background-size: cover; background-repeat: no-repeat; background-position: center center;">
      ...
      <form action="" class="grid grid-cols-5  justify-items-stretch items-center  bg-white border-1 rounded-2xl">
        ...
        <div class="relative">
          ...
          <button class="w-full bg-blue-500 hover:bg-blue-600 text-xl rounded-lg px-10 py-2.5 " style="margin-left: 20%;">
            <a href="reserve.html" style="color: azure;">จอง</a>
          </button>
        </div>
      </form>
  ...
  <script>
    function showLoginForm() {
      ...
      hideRegisterForm(); // ซ่อนแบบฟอร์มการลงทะเบียน
      window.location.href = "#"; // หน้าล็อกอินที่คุณต้องการให้ไปยัง URL ของหน้าเข้าสู่ระบบ
    }
    ...
    function showRegisterForm() {
      hideLoginForm(); // ซ่อนแบบฟอร์มการเข้าสู่ระบบ
      var registerForm = document.getElementById("registerForm");
      registerForm.classList.remove("hidden"); // แสดงแบบฟอร์มการลงทะเบียน
    }

    function hideRegisterForm() {
      var registerForm = document.getElementById("registerForm");
      registerForm.classList.add("hidden"); // เพิ่มคลาส hidden เพื่อซ่อนแบบฟอร์ม
    }
